...
var Rest = (function () {
    ...
    Rest.prototype.call = function (options, circuitBreakerOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var url, breaker;
            return __generator(this, function (_a) {
                url = options.baseURL + options.url;
                breaker = new opossum_1["default"](this.apiCall, circuitBreakerOptions);
                ...
                breaker.fallback(function () {
                    return Promise.reject(new Error("CircuitBreakerException: Endpoint " + url + " not available."));
                });
                return [2, breaker];
            });
        });
    };
    Rest.prototype.apiCall = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, axios["default"].request(options)];
